...
//    var leaves by remember { mutableStateOf(existingLeaves.toMutableSet()) }
                            ...
                            Row(
                                ...
                                IconButton(
                                    onClick = {
                                        ...
                                        // 🔥 Remove from UI (this triggers recomposition)
                                        leaves.remove(date)
                                    },
...
fun showDatePickerWithDisabledDates(
    ...
    disabledDates: List<String>,   // 👈 UPDATED
...
class ManageAvailabilityActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val doctorId = UserPrefs.getID(this)
